...
class NotificationService:
    ...
    def notify_tasting_ready(self, show_title: str) -> None:
        self.send_message(
            f"🎬 Your tasting for <b>{show_title}</b> is now ready on your media server! Enjoy the first few episodes.",
            title="Tasting Ready"
        )

    def notify_universe_found(self, root_title: str, universe_name: str, count: int) -> None:
        self.send_message(
    ...
    def notify_purge(self, show_title: str, reason: str) -> None:
        self.send_message(
